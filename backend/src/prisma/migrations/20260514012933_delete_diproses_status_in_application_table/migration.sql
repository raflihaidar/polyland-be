/*
  ...
  - The values [DIPROSES] on the enum `ApplicationStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ApplicationStatus_new" AS ENUM ('VERIFIKASI_BERKAS', 'MENUNGGU_PEMBAYARAN', 'PENANDATANGANAN', 'DITOLAK', 'SELESAI');
